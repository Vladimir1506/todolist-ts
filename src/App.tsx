...
import {TasksArrayType, TasksType, TaskType, TodoListsType} from './AppWithRedux';
...
const initTasks: TasksType = {
    ...
    [todoListID2]:
        [{taskId: v1(), title: 'Cleaning', isDone: true},
            {taskId: v1(), title: 'Workout', isDone: true},
            {taskId: v1(), title: 'Sleeping', isDone: false},
            {taskId: v1(), title: 'Lunch', isDone: false},
            {taskId: v1(), title: 'Walking in the rain', isDone: false},],
}
